...
extension ByteSink {
  ...
  public func write<S: Sequence>(_ bytes: S) where S.Element == UInt8 {
  ...
  public func print(_ value: some CustomStringConvertible, terminator: String = "\r\n") {
...
public final class PicoUART: SerialPort, @unchecked Sendable {
  ...
  public init(
    _ instance: Instance = .uart0, baudRate: UInt32 = 115_200, clockHz: UInt32 = 48_000_000
  ) {
