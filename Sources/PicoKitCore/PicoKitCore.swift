...
public enum PicoKitError: Error, Equatable, Sendable, CustomStringConvertible {
  ...
  public var description: String {
    ...
    case .invalidTimeout(let microseconds):
      "timeout \(microseconds) us is zero, overflows, or is unsupported"
    case .invalidAddress(let address):
      "I2C address 0x\(String(address, radix: 16)) is outside 0x08...0x77"
...
public struct PicoPin: RawRepresentable, Hashable, Sendable, Comparable, CustomStringConvertible {
  ...
  public init?(rawValue: UInt32) {
    guard rawValue < 30 else { return nil }
...
extension PicoPin {
  public static let gpio0 = try! PicoPin(0)
  public static let gpio1 = try! PicoPin(1)
  public static let gpio2 = try! PicoPin(2)
  public static let gpio3 = try! PicoPin(3)
  public static let gpio4 = try! PicoPin(4)
  public static let gpio5 = try! PicoPin(5)
  public static let gpio6 = try! PicoPin(6)
  public static let gpio7 = try! PicoPin(7)
  public static let gpio8 = try! PicoPin(8)
  public static let gpio9 = try! PicoPin(9)
  public static let gpio10 = try! PicoPin(10)
  public static let gpio11 = try! PicoPin(11)
  public static let gpio12 = try! PicoPin(12)
  public static let gpio13 = try! PicoPin(13)
  public static let gpio14 = try! PicoPin(14)
  public static let gpio15 = try! PicoPin(15)
  public static let gpio16 = try! PicoPin(16)
  public static let gpio17 = try! PicoPin(17)
  public static let gpio18 = try! PicoPin(18)
  public static let gpio19 = try! PicoPin(19)
  public static let gpio20 = try! PicoPin(20)
  public static let gpio21 = try! PicoPin(21)
  public static let gpio22 = try! PicoPin(22)
  public static let gpio23 = try! PicoPin(23)
  public static let gpio24 = try! PicoPin(24)
  public static let gpio25 = try! PicoPin(25)
  public static let gpio26 = try! PicoPin(26)
  public static let gpio27 = try! PicoPin(27)
  public static let gpio28 = try! PicoPin(28)
  public static let gpio29 = try! PicoPin(29)
}
...
public struct Duration: Hashable, Sendable, Comparable {
  ...
  public static func microseconds(_ value: UInt64) throws(PicoKitError) -> Self {
    guard value > 0 else { throw PicoKitError.invalidTimeout(value) }
...
public struct Frequency: Hashable, Sendable, Comparable {
  ...
  public static func hertz(_ value: UInt32) throws(PicoKitError) -> Self {
    guard value > 0 else { throw PicoKitError.invalidFrequency(value) }
    return Self(hertz: value)
  }
...
@inlinable
public func digitalWrite(_ pin: Int, _ state: PinState, using gpio: some DigitalIO)
  throws(PicoKitError)
{
