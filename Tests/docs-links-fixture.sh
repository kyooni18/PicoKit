...
printf '%s\n' '# Fixture docs' > "$tmp/Docs/00-README.md"
...
printf '%s\n' '# Fixture docs' '[Guide](../README.md)' > "$tmp/Docs/00-README.md"
...
printf '%s\n' '# Fixture' '[Docs](Docs/00-README.md)' > "$tmp/README.md"
printf '%s\n' '# Fixture docs' '[Root](../README.md)' > "$tmp/Docs/00-README.md"
