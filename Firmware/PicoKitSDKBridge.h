...
int32_t picokit_spi_init_config(uint32_t instance, uint32_t frequency_hz, uint32_t sck,
                                ...
                                // Only 0 (MSB-first) is supported by RP-series SPI.
...
int32_t picokit_spi_write_dma_timeout(uint32_t instance, uint32_t owner, const uint8_t *bytes, uint32_t count,
                                      uint64_t timeout_us);
int32_t picokit_spi_write16_dma(uint32_t instance, uint32_t owner, const uint16_t *words, uint32_t count);
int32_t picokit_spi_write16_dma_timeout(uint32_t instance, uint32_t owner, const uint16_t *words, uint32_t count,
                                       uint64_t timeout_us);
int32_t picokit_spi_transfer_dma(uint32_t instance, uint32_t owner, const uint8_t *tx, uint8_t *rx, uint32_t count);
int32_t picokit_spi_transfer_dma_timeout(uint32_t instance, uint32_t owner, const uint8_t *tx, uint8_t *rx,
                                         uint32_t count, uint64_t timeout_us);
int32_t picokit_spi_transfer16_dma(uint32_t instance, uint32_t owner, const uint16_t *tx, uint16_t *rx, uint32_t count);
int32_t picokit_spi_transfer16_dma_timeout(uint32_t instance, uint32_t owner, const uint16_t *tx, uint16_t *rx,
                                          uint32_t count, uint64_t timeout_us);
...
int32_t picokit_uart_write_dma_timeout(uint32_t instance, uint32_t owner, const uint8_t *bytes, uint32_t count,
                                       uint64_t timeout_us);
